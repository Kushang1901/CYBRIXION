...
export default function InternshipDetailPage({ params }: PageProps) {
  ...
  const programInfo = {
    'prog-30-day': {
      overviewDetails: 'Our 30-Day Cybersecurity Internship is delivered through self-paced readable lessons, practical guide sheets, and one structured mini project. The curriculum is text-based, with live Q&A sessions scheduled to support your progress. No recorded video playback is offered.',
      outcomes: [
    ...
    'prog-60-day': {
      overviewDetails: 'Our 60-Day Cybersecurity Internship is delivered through deep modules, practical worksheets, two major reports, and resume-mapping webinars. The format is structured text-based lessons with scheduled live sessions. Recorded video playback is not part of this program.',
      outcomes: [
    ...
    'prog-90-day': {
      overviewDetails: 'Our 90-Day Advanced Internship covers a comprehensive core module, track specialization selection, a major audit report, and mock interview preparation. The format consists of structured readable coursework and projects, with live sessions and no recorded video streams.',
      outcomes: [
    ...
    overviewDetails: 'This program is delivered through structured readable coursework and projects.',
  ...
  return (
    <>
      ...
      {/* PROGRAM HERO */}
      <section className="relative pt-[120px] pb-16 bg-[#020B18] text-white bg-grid-pattern border-b border-slate-800/70">
        ...
        <Container className="relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
            ...
            <div className="lg:col-span-4 w-full">
              <div className="p-6 bg-brand-navy border border-slate-800/70 rounded-2xl shadow-xl flex flex-col gap-4">
      ...
      {/* CORE INFO */}
      <section className="py-20 bg-black text-white border-t border-slate-900">
        <Container>
          <div className="max-w-4xl mx-auto flex flex-col gap-10">
            
            {/* Overview — with learning format merged in */}
            <div>
              <h3 className="font-manrope font-extrabold text-xl text-white mb-4">Program Overview</h3>
              <p className="text-sm text-text-dark-secondary leading-relaxed mb-5">
              ...
              <p className="text-sm text-text-dark-secondary leading-relaxed mb-6">
                {programInfo.overviewDetails}
              </p>

              {/* Video disclaimer */}
              <div className="p-3.5 bg-brand-logo-red/5 border border-brand-logo-red/10 rounded-lg flex gap-3 text-brand-logo-red">
            ...
            {program.id === 'prog-90-day' && (
              <div className="bg-brand-navy border border-slate-800/70 p-6 rounded-xl space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-black/40 border border-slate-800/60 rounded-lg hover:border-brand-blue/25 transition-colors">
              ...
              <div className="space-y-4">
                {programModules.map((module) => {
                  ...
                  return (
                    <div 
                      key={module.id} 
                      className="border border-slate-800/70 rounded-xl overflow-hidden shadow-sm"
                    >
                      {/* Header trigger */}
                      <button
                        onClick={() => toggleModule(module.id)}
                        className="w-full px-5 py-4 bg-brand-elevated/40 flex items-center justify-between hover:bg-brand-elevated/60 transition-colors text-left cursor-pointer"
                      >
                        <div className="flex items-center gap-3">
                          <span className="text-xs font-bold text-brand-blue bg-brand-blue/10 border border-brand-blue/20 px-2.5 py-0.5 rounded">
                      ...
                      {/* Content roster */}
                      {isExpanded && (
                        <div className="p-4 bg-black/30 border-t border-slate-800/60 divide-y divide-slate-800/50">
